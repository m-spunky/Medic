...
class _Appo1MedicWidgetState extends State<Appo1MedicWidget>
    with TickerProviderStateMixin {
  late Appo1MedicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Appo1MedicModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFFAEC2FB),
