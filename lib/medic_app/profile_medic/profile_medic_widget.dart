...
import 'profile_medic_model.dart';
export 'profile_medic_model.dart';

class ProfileMedicWidget extends StatefulWidget {
  const ProfileMedicWidget({super.key});

  @override
  State<ProfileMedicWidget> createState() => _ProfileMedicWidgetState();
}

class _ProfileMedicWidgetState extends State<ProfileMedicWidget>
    with TickerProviderStateMixin {
  late ProfileMedicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileMedicModel());
                              ...
                              Card(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(40.0),
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxN3x8ZmFjZXxlbnwwfHx8fDE3MjY4MzA0OTB8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                      width: 80.0,
                                      height: 80.0,
                                      fit: BoxFit.cover,
                                    ),
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'List of past diagnoses, surgeries, or conditions',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .headlineSmall
                                                                .override(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Ongoing conditions (e.g., asthma, hypertension)',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .headlineSmall
                                                                .override(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Vaccines and immunizations taken',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .headlineSmall
                                                                .override(
